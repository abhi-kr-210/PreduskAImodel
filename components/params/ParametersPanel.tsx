...
export function ParametersPanel() {
  ...
  return (
    <div className="h-full flex flex-col bg-white dark:bg-gray-800 border-r border-gray-200 dark:border-gray-700 sidebar-shadow">
      ...
      {/* Parameters Content with Smooth Transitions */}
      <div className={`flex-1 overflow-hidden transition-all duration-300 ease-in-out ${
        ...
        {expanded ? (
          <div className="p-4 space-y-4">
            ...
            <div className="space-y-3 p-4 bg-gradient-to-br from-white to-gray-50 dark:from-gray-800 dark:to-gray-900 border border-gray-200 dark:border-gray-600 rounded-xl enhanced-card">
              <div className="flex items-center justify-between">
                ...
                <span className="text-sm font-mono text-red-600 dark:text-red-400 bg-red-50 dark:bg-red-900/20 px-3 py-1.5 rounded-lg text-xs font-semibold border border-red-200 dark:border-red-800">
            ...
            <div className="space-y-3 p-4 bg-gradient-to-br from-white to-gray-50 dark:from-gray-800 dark:to-gray-900 border border-gray-200 dark:border-gray-600 rounded-xl enhanced-card">
              <div className="flex items-center justify-between">
                ...
                <span className="text-sm font-mono text-blue-600 dark:text-blue-400 bg-blue-50 dark:bg-blue-900/20 px-3 py-1.5 rounded-lg text-xs font-semibold border border-blue-200 dark:border-blue-800">
                  {maxTokens}
                </span>
              </div>
              <Slider
            ...
            <div className="space-y-3 p-4 bg-gradient-to-br from-white to-gray-50 dark:from-gray-800 dark:to-gray-900 border border-gray-200 dark:border-gray-600 rounded-xl enhanced-card">
              <div className="flex items-center justify-between">
                ...
                <span className="text-sm font-mono text-green-600 dark:text-green-400 bg-green-50 dark:bg-green-900/20 px-3 py-1.5 rounded-lg text-xs font-semibold border border-green-200 dark:border-green-800">
                  {topP.toFixed(2)}
                </span>
              </div>
              <Slider
          ...
          // Enhanced collapsed state with tooltips
      ...
      {/* Enhanced Footer (text removed for minimal UI) */}
      <div className="flex-shrink-0 p-2 border-t border-gray-200 dark:border-gray-700 bg-gradient-to-t from-gray-50 to-transparent dark:from-gray-900 dark:to-transparent" />
    </div>
  );
}
