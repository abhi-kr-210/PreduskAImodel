  ...
  return (
    <div className="min-h-screen bg-white dark:bg-gray-900">
      ...
      <div className="flex h-[calc(100vh-80px)] relative">
        ...
        <aside
          className={`fixed top-0 left-0 z-50 h-full bg-white dark:bg-gray-800 border-r border-gray-200 dark:border-gray-700 shadow-xl transition-all duration-300 ease-in-out lg:static lg:translate-x-0 lg:shadow-none ${
